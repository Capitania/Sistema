...
'Public Const Ver = "2.139"               '10-Jul-2020 'Correção de Int --> Long em GetYourADTVIn
'Public Const Ver = "2.140"               '27-Jul-2020 'Correção de erro na importação de carteira txt
'Public Const Ver = "2.141"               '07-Aug-2020 'Filtro de erro ao ler planilha de trades do Excel
'Public Const Ver = "2.142"               '14-Aug-2020 'Eliminar o erro de log de número negativo no cálculo da vol de fator de risco
'Public Const Ver = "2.143"               '23-Aug-2021 'Crítica do filetab na abertura de Excel
'Public Const Ver = "2.144"               '20-Out-2021 'email de PTC traz apenas regras CTRL
'Public Const Ver = "2.145"               '19-Nov-2021 'Aumentou no de resgates para 5000 (CFundo)
Public Const Ver = "2.146"                '16-Fev-2022 'Acrescentou teste se quota(t-1)>0 no C_Fundo
    ...
    If Not Excel Is Nothing Then
        ...
        If Mid(FileName, i, 1) = "\" Then
            ...
            If Not wb Is Nothing Then
                If FileTab = "\WORKBOOK" Then
                    Set OpenAndSetExcel = wb
                Else
                    For Each ws1 In wb.worksheets
                        If ws1.Name = FileTab Then Set OpenAndSetExcel = wb.worksheets(FileTab)
                    Next ws1
                End If
            End If
        End If
